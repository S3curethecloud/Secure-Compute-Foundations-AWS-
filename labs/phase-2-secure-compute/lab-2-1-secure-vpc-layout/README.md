...
In this lab, you will design and implement a production-grade VPC layout that enforces network tiering, blast-radius reduction, and secure routing intent.
...
⚠️ Disable auto-assign public IPv4
This is mandatory.
...
Create route table: stc-p2-rt-public
...
Create route table: stc-p2-rt-private-app
...
❌ No IGW route
✔ Internet access will come later via NAT (Lab 2.2)
